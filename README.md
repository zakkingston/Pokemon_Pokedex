...
<h1 align="center">Pokemon - Pokedex</h1>
...
The project using the [Pokedex](https://pokeapi.co/) for constructing RESTful API.<br>
Pokedex provides a RESTful API interface to highly detailed objects built from thousands of lines of data related to Pokémon.
